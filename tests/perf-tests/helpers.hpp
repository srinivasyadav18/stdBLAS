...
template <class T>
class _blas1_signed_fixture
{
public:
    using value_type = T;
    std::size_t myExtent;

    _blas1_signed_fixture(std::size_t myExtent_)
      : myExtent(myExtent_), x_data(myExtent_), y_data(myExtent_), z_data(myExtent_),
        x(x_data.data(), myExtent_), y(y_data.data(), myExtent_),
        z(z_data.data(), myExtent_)
    {
