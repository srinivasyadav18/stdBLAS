...
template<class ExPolicy, class A_t, class x_t, class y_t, class z_t>
void hpx_blas_updating_gemv_impl(ExPolicy policy, A_t A, x_t x, y_t y, z_t z)
{
  ...
  auto z_preKernel = hpxtesting::create_stdvector_and_copy(z);
  ...
  stdla::matrix_vector_product(policy, A, x, y, z);
...
TEST_F(blas2_signed_float_fixture, hpx_updating_matrix_vector_product)
{
  hpx_blas_updating_gemv_impl(HPXKernelsSTD::hpx_exec<>(), A_e0e1, x_e1, x_e0, y_e0);
  hpx_blas_updating_gemv_impl(hpx::execution::par, A_e0e1, x_e1, x_e0, y_e0);
  hpx_blas_updating_gemv_impl(hpx::execution::par_unseq, A_e0e1, x_e1, x_e0, y_e0);
}

TEST_F(blas2_signed_double_fixture, hpx_updating_matrix_vector_product)
{
  hpx_blas_updating_gemv_impl(HPXKernelsSTD::hpx_exec<>(), A_e0e1, x_e1, x_e0, y_e0);
  hpx_blas_updating_gemv_impl(hpx::execution::par, A_e0e1, x_e1, x_e0, y_e0);
  hpx_blas_updating_gemv_impl(hpx::execution::par_unseq, A_e0e1, x_e1, x_e0, y_e0);
...
TEST_F(blas2_signed_complex_double_fixture, hpx_updating_matrix_vector_product)
{
